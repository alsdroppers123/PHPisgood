            ...
            <div class="login">
                <div class="login_box">
                    <form action="connect_retrieve.php" method='post' >
                        <h1>LOGIN</h1><br><br>
                        <input type="text" id="username" name="username" class="in1" placeholder="Username"><br><br>
                        <input type="password" id="password" name="password" class="in2" placeholder="Password"><br>
                        <input type="submit" class="in3" value="Login"><br><br>
                        <h3>OR</h3>
                        <div class="logso">
                            <a href="signup.php"><input type="button" class="in3" value="Signup"></a>
                        </div>
                    </form>
                </div>
                </div>
